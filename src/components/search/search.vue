                ...
                <el-row>
                    <el-col :sm="8" :xs="8">
                        ...
                        size="mini">
                            ...
                            placeholder="开始日期" 
                            style="width:35%"
                            v-model="s_form.dateS">
                            </el-date-picker>
                            <el-date-picker
                            type="date" 
                            placeholder="结束日期" 
                            style="width:35%"
                            v-model="s_form.dateE">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :sm="8" :xs="8">
                        <el-form-item size="mini">
                            ...
                            <el-select v-model="s_form.tower" 
                            multiple 
                            placeholder="请选择">
                            <el-option v-for="item in Towerarr"
                            :key="item"
                            :label="item"
                            :value="item"
                            >
